  ...
  return (
    <React.Fragment>
     <div className="navbar">
        <h1 className="text-center">Abhi Pic Store</h1>
        <p className="main-text copy-section">Image Search App &copy; By Abhishek Vishwakrma</p>
     </div>
    <div className="container py-5">
      <div className="pb-5">
        ...
        <div onClick={reset} className="text-center reset">{searchQ && ('Reset Search')}</div>
      </div>
      ...
      <p className="main-text copy-section-footer">Image Search App &copy; By Abhishek Vishwakrma</p>
    </div>
    </React.Fragment>
  );
}
